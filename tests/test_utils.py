...
@pytest.fixture
def test_transactions() -> list[dict[str, str] | dict[str, str] | dict[str, str] | dict[str, str] | dict[str, str]]:
    return [
        {
            "Дата операции": "01.06.2023 12:00:00",
            "Сумма операции": "-100.50",
...
def test_greeting(mock_datetime: Mock, current_hour: int, expected_greeting: str) -> None:
