...
def test_analyze_cashback(transactions: list, year: int, month: int, expected_output: str) -> Any:
...
def test_search_transactions_by_user_choice(transactions: list, search: str, expected_output: str) -> None:
